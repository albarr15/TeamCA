...
description: Standard operating procedure and checklist for testing critical application flows.
---

:::tip[Standard Operating Procedure]
This page serves as the official reference guide for verifying critical system flows before a major release. 

**Testing Note:** When performing an actual test, please use the **QA Smoke Test Checklist** template inside **GitHub Issues** to generate an interactive, trackable version of this list!
:::
